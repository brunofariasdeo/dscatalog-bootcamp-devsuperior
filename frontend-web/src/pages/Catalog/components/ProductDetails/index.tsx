        ...
        <div className="row">
          ...
          <div className="col-6 product-details-card">
            ...
            <p className="product-description-text">
              ...
              aplicativos simultâneos na tela. 
              A tela está ficando abarrotada? Crie áreas de trabalho virtuais 
              para obter mais espaço e trabalhar com os itens que você deseja. 
